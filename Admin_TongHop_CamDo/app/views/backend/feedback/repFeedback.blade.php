...
<div class="contentwrapper">
    <div class="subcontent">
        ...
        {{Form::open(array('action'=>'\BackEnd\FeedbackController@postTraLoi', 'class'=>'stdform','id'=>'fillterfrom'))}}
        <p>
        ...
        <p class="stdformbutton">
            <button class="submit radius2" style=" margin-left: 30px;">{{Lang::get('general.reply')}}</button>
