...
<div class="contentwrapper">
    ...
    <div class="subcontent">
        ...
        <div class="tableoptions">
            {{Form::open(array('action'=>'\BackEnd\PageController@postFillterPageView', 'class'=>'stdform stdform2','id'=>'fillterfrom'))}}
            <?php
            ...
            {{Form::close()}}
            {{Form::open(array('action'=>'\BackEnd\PageController@getSeaechPageView','id'=>'searchaction'))}}
