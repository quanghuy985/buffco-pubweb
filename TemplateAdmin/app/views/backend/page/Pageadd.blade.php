...
@if(!isset($arrayPage))
{{Form::open(array('action'=>'PageController@postAddPage', 'id'=>'addPage', 'class'=>'stdform stdform2'))}}
@else
{{Form::model($arrayPage, array('action'=>'PageController@postUpdatePage', 'id'=>'addPage', 'class'=>'stdform stdform2'))}}
@endif
