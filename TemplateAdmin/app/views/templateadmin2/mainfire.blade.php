...
<html lang="vi">
    ...
    <head>
        ...
        <script type="text/javascript" src="{{Asset('adminlib2/js/plugins/jquery.tagsinput.min.js')}}"></script>
        <script type="text/javascript" src="{{Asset('adminlib2/js/plugins/jquery.alerts.js')}}"></script>
         <script type="text/javascript" src="{{Asset('adminlib2/js/plugins/jquery.jgrowl.js')}}"></script>
