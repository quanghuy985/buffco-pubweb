        ...
        <p>
            ...
            <span class="field">
                ...
                <select name="home" id="home" size="5">                    
                    <option value="{{action('HomeController@getHome')}}">Trang chủ</option>

                </select>
                <select name="internal" id="internal" size="5">                    
                    @if(isset($menu))
                    @foreach($menu as $item)
                    <option value="'PageController@getPageBySlug'?slug={{$item->pageSlug}}">{{$item->pageName}}</option>
                    @endforeach
                    @endif
                </select>
                <select name="catenews" id="catenews" size="5">
                    ...
                    <option value="------------">
                        @if($item->catenewsParent ==0)  <strong>
                        @endif @if($item->catenewsParent !=0) &nbsp;-&nbsp;
                        @endif {{$item->catenewsName}} @if($item->catenewsParent ==0)
                    </strong> @endif</option>
                    @endforeach
                    @endif
                </select>
