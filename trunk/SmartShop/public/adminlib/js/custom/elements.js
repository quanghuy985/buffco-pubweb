...
jQuery(document).ready(function() {
    ...
    jQuery(document).scroll(function() {
        if (jQuery('.jGrowl').length != 0) {
            ...
            if (pos < 50)
                jQuery('.jGrowl').css({top: '55px'});
            else
                jQuery('.jGrowl').css({top: '0'});
        }
    });
...
//    });
    ...
    jQuery("#datepicker").datepicker("option", "monthNames", ["Tháng Một", "Tháng Hai", "Tháng Ba", "Tháng Tư", "Tháng Năm", "Tháng Sáu", "Tháng Bảy", "Tháng Tám", "Tháng Chín", "Tháng Mười", "Tháng Mười Một", "Tháng Mười Hai"]);
    jQuery("#datepicker").datepicker("option", "dayNamesMin", ["Hai", "Ba", "Tư", "Năm", "Sáu", "Bảy", "CN"]);
    jQuery("#datepicker1").datepicker();
    jQuery("#datepicker1").datepicker("option", "monthNames", ["Tháng Một", "Tháng Hai", "Tháng Ba", "Tháng Tư", "Tháng Năm", "Tháng Sáu", "Tháng Bảy", "Tháng Tám", "Tháng Chín", "Tháng Mười", "Tháng Mười Một", "Tháng Mười Hai"]);
    jQuery("#datepicker1").datepicker("option", "dayNamesMin", ["Hai", "Ba", "Tư", "Năm", "Sáu", "Bảy", "CN"]);
    jQuery("#datepicker2").datepicker();
    jQuery("#datepicker2").datepicker("option", "monthNames", ["Tháng Một", "Tháng Hai", "Tháng Ba", "Tháng Tư", "Tháng Năm", "Tháng Sáu", "Tháng Bảy", "Tháng Tám", "Tháng Chín", "Tháng Mười", "Tháng Mười Một", "Tháng Mười Hai"]);
    jQuery("#datepicker2").datepicker("option", "dayNamesMin", ["Hai", "Ba", "Tư", "Năm", "Sáu", "Bảy", "CN"]);
