...
namespace {
	...
	class Timthumb extends \Spescina\Timthumb\Facades\Timthumb{
		/**
		 * 
		 *
		 * @static 
		 */
		 public static function get($src, $w = 0, $h = 0, $zc = 3){
			//Method inherited from \Spescina\Timthumb\Timthumb
			 \Spescina\Timthumb\Timthumb::get($src, $w, $h, $zc);
		 }
		 ...
		 * @static 
		 */
		 public static function link($src, $w = 0, $h = 0, $zc = 1){
			//Method inherited from \Spescina\Timthumb\Timthumb
			 \Spescina\Timthumb\Timthumb::link($src, $w, $h, $zc);
		 }
