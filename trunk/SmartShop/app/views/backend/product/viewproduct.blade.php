...
<script>
    var urlfillter = '{{action('\BackEnd\ProductController@postFillterProduct')}}';</script>
    ...
    <div class="subcontent">
        ...
        <div class="tableoptions">
            <form class="stdform stdform2" action="javascript:void(0)" method="post">
                ...
                &nbsp; &nbsp; {{Form::select('status_fillter', Lang::get('general.product_status'),null,array('id'=>'status_fillter','class'=>'radius3'))}}&nbsp; &nbsp;<button class="radius3" id="loctheotieuchi" onclick="ajaxfillter_all('{{action('\BackEnd\ProductController@postFillterProduct')}}', jQuery('#cat_product_id').val(), jQuery('#status_fillter').val())">{{Lang::get('general.filter')}}</button>
            ...
            <div class="dataTables_filter1" id="searchformfile" style=" margin-top: -32px !important;">
                ...
                &nbsp; &nbsp;
                <a style=" float: right;height: 30px;" onclick="timkiem()" class="btn btn4 btn_search" href="javascript:void(0)"></a>
            </div>
        </div>
