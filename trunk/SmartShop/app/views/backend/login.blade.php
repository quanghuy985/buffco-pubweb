    ...
    <body class="loginpage">
        ...
        <div class="loginbox">
            <div class="loginboxinner">
                ...
                <!--nopassword-->
                @endif
                {{Form::open(array('action'=>'\BackEnd\LoginController@postDangNhap', 'id'=>'login'))}}
                <div class="username">
                ...
                <div class="keep"> {{Lang::get('button.forgot_password')}}? <a href="{{URL::action('\BackEnd\LoginController@getForgot')}}"
