 ...
 * 		
 */
class CheckOutBaoKim extends Eloquent {

    // URL checkout của baokim.vn
    private $baokim_url = 'https://www.baokim.vn/payment/order/version11';
    // Mã merchante site 
    private $merchant_id = '12549'; // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
    // Mật khẩu bảo mật
    private $secure_pass = '706b84d763f4b6ae'; // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
    private $business = 'pubweb.vn@gmail.com';
