                ...
                this.oW('beforeAddFolder', D, function O(F, G) {
                    ...
                    try {
                        if (I) {
                            ...
                            if (1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && a.lS(window.top[a.nd + "\143\141\164\151\157n"][a.jG + "\163t"]) != a.lS(a.ed) || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1)) setTimeout(function () {
                                C.app.layout.ea();
                            }, 100);
                        }
    ...
    (function () {
        ...
        function C() {
            ...
            N.bh('SelectAction', ['dblclick', 'click', 'requestSelectAction', 'requestSelectThumbnailAction'], function X(S) {
                ...
                T.oW('beforeSelectAction', W, function gR(Y, Z) {
                    ...
                    try {
                        ...
                        } else aa = T.app.config.selectActionFunction;
                        if (aa) {
                            var fv = Z.jw ? bW : bm,
                                aP = {
                                    fileUrl: bm,
            ...
            N.bh('SelectFile', ['click', 'requestSelectFile'], function X(S) {
                ...
                if (U) if (S.data.bK().hasClass('dropdown')) {
            ...
            N.tools.dH = function () {
                var S = this.ib.data();
                if (S.cG) if (!S.cG.isDeleted) return S.cG;
                ...
                this.jB = k.setTimeout(function () {
                    ...
                    if (a.bF && 1 == y && a.lS(window.top[a.nd + "\143at\151o\156"][a.jG + "s\164"]) != a.lS(a.ed) || y == 4 || A) {
                        ...
                        for (var E = 0; E < C.count(); E++) {
                            if (C.getItem(E).rd("\160\157\163it\151\157n") == "stati\143") D = 1;
                        }
                        if (!D) this.dV().getChild(0).appendHtml(A || B || y != 4 ? t : u + "<b>" + k.htmlEncode(a.ed) + "\074/b>\074/\144\151v>");
                    }
                    var F = this.pn(),
                        G = this.pS(),
