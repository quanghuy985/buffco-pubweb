...
//
//    public function insertProduct($cateID, $productCode, $productName, $productDescription, $productAttributes, $productPrice, $productSlug, $productTag, $manufactureID, $salesPrice, $startSales, $endSales, $status) {
//
