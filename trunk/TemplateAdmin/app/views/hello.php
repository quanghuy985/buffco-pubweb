...
<html lang="en">
    ...
    <body>
        <div class="welcome">
            ...
            <form  class="ng-valid ng-dirty" method="POST" action="<?php echo Asset('camvaoday/adminuser/register'); ?>">
                <input type="text" name="userName" ng-model="newMsg" placeholder="Type your message" class="ng-valid ng-dirty">
                <input type="text" name="password" ng-model="newMsg" placeholder="Type your message" class="ng-valid ng-dirty">
                <input type="text" name="name" ng-model="newMsg" placeholder="Type your message" class="ng-valid ng-dirty">
