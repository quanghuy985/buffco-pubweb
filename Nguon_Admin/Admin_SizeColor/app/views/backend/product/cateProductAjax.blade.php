...
<tr> 
    ...
    <td>
        <a href="{{URL::action('\BackEnd\ProductController@getCateProductEdit')}}/{{$item->id}}"  title="Sửa"> Sửa</a>
        &nbsp;&nbsp;|&nbsp;&nbsp;<a href="javascript: void(0)" onclick="deleteproduct('{{URL::action('\BackEnd\ProductController@postDeleteCateProduct')}}',{{$item->id}})"title="Xóa">Xóa</a>
    </td> 
</tr> 
@endforeach
@if($link!='')
