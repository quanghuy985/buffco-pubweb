...
<div class="contentwrapper">
    <div class="subcontent">
        ...
        <form class="stdform stdform2" method="post" action="{{URL::action('FeedbackController@postReplyFeedback')}}">

            <p>
                <input type="hidden" name="id" id="feedbackID" value="@if(isset($feedbackdata)){{$feedbackdata->id}}@endif"/>
            </p>
            <p>
                <label>Email :</label>
                <span class="field">
            ...
            <p>
                ...
                <span class="field">
                    <input type="hidden" name="feedbackTime" placeholder="Chủ đề phản hồi" value="@if(isset($feedbackdata))<?php echo date('d/m/Y h:i:s', $feedbackdata->feedbackTime); ?>@endif" class="longinput">
                    <input type="text" name="feedbackTime1" placeholder="Chủ đề phản hồi" @if(isset($feedbackdata))disabled @endif value="@if(isset($feedbackdata))<?php echo date('d/m/Y h:i:s', $feedbackdata->feedbackTime); ?>@endif" class="longinput">
                </span>
            </p>
            <p>
